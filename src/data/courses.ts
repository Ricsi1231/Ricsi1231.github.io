...
export const courses: Course[] = [
  ...
  },
  {
    ...
    title: {
      en: 'ROS 2 and Gazebo Basics',
      hu: 'ROS 2 és Gazebo alapjai',
    },
    summary: {
      en: 'Build a mobile robot that finds its own way around, entirely in simulation — nodes and topics, a robot you describe yourself, simulated sensors, a map it builds while driving, and a path planner you can watch think.',
      hu: 'Építs mobilrobotot, amely magától tájékozódik, teljesen szimulációban — node-ok és topicok, egy robot, amelyet te írsz le, szimulált szenzorok, menet közben épülő térkép, és egy útvonaltervező, amelynek végignézheted a gondolkodását.',
    },
    topics: {
      en: [
  ...
  },
  {
    ...
    summary: {
      en: 'A board where analog and digital have to share the same copper — floorplanning, power integrity, grounding, analog front-ends, EMC and heat, and the layout decisions that determine whether the quiet signals stay quiet.',
      hu: 'Olyan panel, ahol az analóg és a digitális ugyanazon a rézen osztozik — elrendezéstervezés, tápintegritás, földelés, analóg bemeneti fokozatok, EMC és hőkezelés, valamint azok a huzalozási döntések, amelyeken múlik, hogy a halk jelek halkak maradnak-e.',
    },
    topics: {
      en: [
